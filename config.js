module.exports = {
  OWNER_IDS: ["1307017787599749262"], // Bot owner ID's
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1392189770297249893", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
